...
const formSchema = z.object({
  ...
  lastName: z
    ...
    .max(20, 'Фамилия должна содержать максимум 20 символов')
})
  ...
  return (
    <Card className='border-0 bg-slate-900/90 backdrop-blur-xl'>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <div className='group relative'>
                      <User className='absolute top-2.5 left-3 h-5 w-5 text-gray-500 transition-colors group-focus-within:text-purple-400' />
                      <Input
                        placeholder='Иван'
                        className='border-gray-700 bg-slate-800/50 pl-10 text-white placeholder:text-gray-500 focus:border-purple-500 focus:ring-1 focus:ring-purple-500'
                        {...field}
      ...
      <CardFooter className='flex flex-col gap-2'>
        ...
        >
          Уже есть аккаунт?{' '}
          <span className='font-semibold text-purple-400'>Войти</span>
        </button>
      </CardFooter>
    </Card>
  )
